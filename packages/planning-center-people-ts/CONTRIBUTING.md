...
Documentation is maintained in the monorepo documentation site. When adding features:

1. **Update concepts** (`../../docs/content/concepts.mdx`) - If adding new mental models
2. **Update config reference** (`../../docs/content/reference/config.mdx`) - If adding config options
3. **Update examples** (`../../docs/content/recipes/examples.mdx`) - If adding common patterns
4. **Update LLM context** (`../../docs/content/llm-context.mdx`) - If changing public API
5. **Update CHANGELOG.md** - For user-facing changes

All documentation files are in `docs/content/` at the monorepo root.
...
- Check existing issues: <https://github.com/rachelallyson/planning-center-monorepo/issues>
- Review documentation: `../../docs/content/index.mdx` (monorepo docs site)
