...
**See [Event System Guide](./event-system.mdx) for complete documentation of all event types and advanced patterns.**
...
- **[Event System Guide](./event-system.mdx)** - Complete event monitoring and observability
